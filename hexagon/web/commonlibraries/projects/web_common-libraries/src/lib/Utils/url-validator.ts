/**
 * @deprecated Use the url helper in web_common-http
...
export class UrlValidator {
    ...
    /** 
     * @deprecated Use url helper in web_common-http
     * Validates URL
     */
    static isValid(url: string) {
        // This is the regex expression also used by the backend (.NET UrlAttribute.IsValid())
