...
import { LayerPropertiesWMSTranslationTokens } from './layer-properties-hxcpWMS.translation';
import { Subject } from 'rxjs';
import { takeUntil } from 'rxjs/operators';

@Component({
    selector: 'hxgn-commonmap-admin-layer-properties-hxcpwms',
    templateUrl: './layer-properties-hxcpWMS.component.html',
    styleUrls: ['./layer-properties-hxcpWMS.component.scss']
})
export class LayerPropertiesHxCPWMSComponent implements OnInit, OnChanges, OnDestroy {
                    ...
                    if (this.canFetchLayers) {
                        ...
                        await this.mapAdminSvc.getAvailableWMSInfo(this.mapLayer, fetchData).catch( (reason: any) =>  {
                            ...
                            if (wmsInfo) {
                                ...
                                if (wmsVersion) {
                                    this.mapLayer.upsertOption('version', wmsVersion);
                                }
