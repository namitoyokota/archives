...
declare module 'leaflet' {
    ...
    namespace DrawOptions {
        ...
        interface DrawErrorOptions {
            ...
            deleteCoordError?: string | undefined;
        }
    }
    ...
    namespace Draw {
        ...
        namespace Event {
            ...
            const UNDOABLEEDIT: 'draw:undoableedit';
            ...
            const RADIUSCHANGE: 'draw:radiuschange';
        }
        ...
        class Polyline extends Feature {
            ...
            deleteLastVertex(): LatLng;

            addVertex(latlng: LatLng, shouldFire: boolean): void;
