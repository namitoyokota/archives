...
export class CreateDataSharingInjectableComponent extends FilterCriteriaEditor {
    ...
    constructor(@Inject(LAYOUT_MANAGER_SETTINGS) public settings: FilterCriteriaEditorSettings,
     ...
     * @param filterLevel The new filter level
     */
     ...
     * If no grouping if found a new grouping will be created.
     * @param level The restriction group to look for
     */
     ...
     * @param level The level to get read only filter for
     */
     ...
     * @param group The Restriction grouping that has changed
     */
