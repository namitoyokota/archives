...
import { ShapeHistoryItemSettings$v1, LAYOUT_MANAGER_SETTINGS } from '@galileo/web_shapes/_common';
...
export class ChannelAssociationHistoryItemComponent implements OnInit {
    ...
    constructor(@Inject(LAYOUT_MANAGER_SETTINGS) private historyItemSettings: ShapeHistoryItemSettings$v1) { }
