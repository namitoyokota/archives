...
import { PopupEvents } from './constants/popup-constants';
import { OverlayManagerEvents } from '../overlay-manager/constants/overlay-manager-constants';
import type { IPopupEventArgs, IPopupToggleModel } from './interfaces/popup-interfaces';
import type { ICallbackEventArgs } from '../overlay-manager/interfaces/overlay-manager-interfaces';
...
export class Popup {
    ...
    toggleModel: IPopupToggleModel | undefined;

    viewModel: IPopupEventArgs | undefined;
    ...
    attached() {
        ...
        this.onHidePopupSubscriber = this.ea.subscribe(PopupEvents.ON_HIDE_POPUP, () => {
            if (this.isInView) {
                this.hidePopup();
            }
        });

        this.onShowPopupSubscriber = this.ea.subscribe(PopupEvents.ON_SHOW_POPUP, async (viewModel: IPopupEventArgs) => {
    ...
    togglePopup(model: IPopupToggleModel): void {
